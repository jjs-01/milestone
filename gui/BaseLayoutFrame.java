...
/**
 * This class defines the basic layout of the screen, with the centre panel as either the note
 * or taskList and the button sidebar.
 * 
...
public class BaseLayoutFrame extends JFrame {
    private final JPanel centreOption = new JPanel();
    private final JScrollPane taskScrollPane = new JScrollPane(new TaskListPanel());
    private final JScrollPane noteScrollPane = new JScrollPane(new NoteAppPanel());
    private final JButton toDoButton = new JButton("To Do List");
    private final JButton noteButton = new JButton("Important Notes");
    ...
    /**
     * This inner class is an action listener for the buttons in the sidebar. It 
    ...
    class ButtonEventListener implements ActionListener {
         ...
         * a button is pressed. This specifically changes the middle panel.
         * 
